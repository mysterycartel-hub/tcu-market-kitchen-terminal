...
export default function VaultPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-slate-100">
      <TopMarketBar selectedSymbol={DEFAULT_SYMBOL} grade="--" mode="Vault" onChefRead={() => {}} onChecklist={() => {}} />
      <main className="mx-auto max-w-7xl px-6 py-8 space-y-6">
        <section className="rounded-3xl border border-white/10 bg-slate-950/70 p-6 flex flex-wrap items-end justify-between gap-4">
          <div>
            ...
            <h2 className="mt-2 text-3xl font-black">Flashcards, structure, and daily XP</h2>
            <p className="mt-3 text-slate-300 max-w-3xl">Review core terms, earn XP, and keep your market language simple.</p>
          </div>
